...
export function HeroShield() {
  ...
  return (
    <div ref={wrap} onMouseMove={onMove} onMouseLeave={reset} className="relative flex items-center justify-center">
      <div className="hero-parallax">
        <div className="shield-float">
          <svg
            viewBox="0 0 420 420"
            preserveAspectRatio="xMidYMid meet"
            shapeRendering="geometricPrecision"
            role="img"
            aria-label="درع حصن المتوهج فوق أوراق دافئة بأشكال زمردية"
          ...
          >
            ...
            <circle cx="210" cy="215" r="150" fill="url(#glow)" className="glow-pulse" />
...
export function LogoMark({ size = 36 }: { size?: number }) {
  return (
    <span className="gradient-emerald inline-flex items-center justify-center rounded-xl transition-transform duration-300 group-hover:rotate-6 group-hover:scale-105" style={{ width: size, height: size }}>
      <svg viewBox="0 0 200 200" width={size * 0.66} height={size * 0.66} aria-hidden="true" shapeRendering="geometricPrecision" preserveAspectRatio="xMidYMid meet">
